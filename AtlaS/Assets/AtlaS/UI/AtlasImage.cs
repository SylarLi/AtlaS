...
namespace AtlaS.UI
{
    ...
    public class AtlasImage : MaskableGraphic, ISerializationCallbackReceiver, ILayoutElement, ICanvasRaycastFilter
    {
        ...
        public Sprite overrideSprite { get { return activeSprite; } set { if (m_OverrideSprite != value) { m_OverrideSprite = value; SetAllDirty(); } } }
        ...
        public Type type { get { return m_Type; } set { if (m_Type != value) { m_Type = value; SetVerticesDirty(); } } }
        ...
        public bool fillCenter { get { return m_FillCenter; } set { if (m_FillCenter != value) { m_FillCenter = value; SetVerticesDirty(); } } }

        /// Filling method for filled sprites.
        [SerializeField]
        private FillMethod m_FillMethod = FillMethod.Radial360;
        public FillMethod fillMethod { get { return m_FillMethod; } set { if (m_FillMethod != value) { m_FillMethod = value; SetVerticesDirty(); m_FillOrigin = 0; } } }

        /// Amount of the Image shown. 0-1 range with 0 being nothing shown, and 1 being the full Image.
        [Range(0, 1)]
        [SerializeField]
        private float m_FillAmount = 1.0f;
        public float fillAmount { get { return m_FillAmount; } set { if (m_FillAmount != Mathf.Clamp01(value)) { m_FillAmount = Mathf.Clamp01(value); SetVerticesDirty(); } } }

        /// Whether the Image should be filled clockwise (true) or counter-clockwise (false).
        [SerializeField]
        private bool m_FillClockwise = true;
        public bool fillClockwise { get { return m_FillClockwise; } set { if (m_FillClockwise != value) { m_FillClockwise = value; SetVerticesDirty(); } } }

        /// Controls the origin point of the Fill process. Value means different things with each fill method.
        [SerializeField]
        private int m_FillOrigin;
        public int fillOrigin { get { return m_FillOrigin; } set { if (m_FillOrigin != value) { m_FillOrigin = value; SetVerticesDirty(); } } }
